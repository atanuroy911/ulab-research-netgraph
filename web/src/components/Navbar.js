...
import { Network, Users, Search, Info, Shuffle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <nav className="flex space-x-1 sm:space-x-4">
            ...
            <Link href="/collaborate" className="flex items-center gap-1.5 px-3 py-2 rounded-md text-sm font-medium hover:bg-white/10 transition-colors">
              <Shuffle size={18} />
              <span className="hidden sm:inline">Cross-Disciplinary</span>
            </Link>
